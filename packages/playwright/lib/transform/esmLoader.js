...
const kSupportedFormats = new Map([['commonjs', 'commonjs'], ['module', 'module'], ['commonjs-typescript', 'commonjs'], ['module-typescript', 'module'], [null, null], [undefined, undefined]]);
...
async function load(moduleUrl, context, defaultLoad) {
  ...
  if (!kSupportedFormats.has(context.format)) return defaultLoad(moduleUrl, context, defaultLoad);
  ...
  return {
    format: kSupportedFormats.get(context.format) || ((0, _util.fileIsModule)(filename) ? 'module' : 'commonjs'),
