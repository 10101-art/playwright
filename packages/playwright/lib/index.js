...
const playwrightFixtures = {
  ...
  _optionAttachErrorContext: [false, {
    scope: 'worker',
    option: true
  }],
  _reuseContext: [async ({
...
class ArtifactsRecorder {
  constructor(playwright, artifactsDir, screenshot, attachErrorContext) {
    ...
    this._attachErrorContext = void 0;
  ...
  async _takePageSnapshot(context) {
    ...
    try {
      ...
      this._pageSnapshot = await (page === null || page === void 0 ? void 0 : page.locator('body').ariaSnapshot({
        timeout: 5000
      }));
    } catch {}
  }
  ...
  async didFinishTest() {
    ...
    if (this._attachErrorContext) await (0, _prompt.attachErrorContext)(this._testInfo, this._pageSnapshot);else await (0, _prompt.attachErrorPrompts)(this._testInfo, this._sourceCache, this._pageSnapshot);
  }
