...
class TestInfoImpl {
  ...
  constructor(configInternal, projectInternal, workerParams, test, retry, onStepBegin, onStepEnd, onAttach) {
    ...
    this.skip = (0, _transform.wrapFunctionWithLocation)((location, ...args) => this._modifier('skip', location, args));
    this.fixme = (0, _transform.wrapFunctionWithLocation)((location, ...args) => this._modifier('fixme', location, args));
    this.fail = (0, _transform.wrapFunctionWithLocation)((location, ...args) => this._modifier('fail', location, args));
    this.slow = (0, _transform.wrapFunctionWithLocation)((location, ...args) => this._modifier('slow', location, args));
  }
...
class TestStepInfoImpl {
  constructor(testInfo, stepId) {
    ...
    this._stepId = void 0;
    this.skip = (0, _transform.wrapFunctionWithLocation)((location, ...args) => {
      // skip();
