...
class TeleReporterEmitter {
  ...
  _serializeResultEnd(result) {
    ...
    return {
      ...
      annotations: (_result$annotations = result.annotations) !== null && _result$annotations !== void 0 && _result$annotations.length ? this._relativeAnnotationLocations(result.annotations) : undefined
    };
  }
  ...
  _relativeAnnotationLocations(annotations) {
    return annotations.map(annotation => {
      if (annotation.location) annotation.location = this._relativeLocation(annotation.location);
      return annotation;
    });
  }
