...
// ../playwright-core/src/client/eventEmitter.ts
...
// ../playwright-core/src/protocol/validatorPrimitives.ts
...
// ../playwright-core/src/protocol/validator.ts
...
// ../playwright-core/src/utils/isomorphic/stackTrace.ts
...
// ../playwright-core/src/client/clientStackTrace.ts
...
// ../playwright-core/src/client/channelOwner.ts
var ChannelOwner = class _ChannelOwner extends EventEmitter {
  ...
  _toImpl() {
    var _a, _b;
    return (_b = (_a = this._connection).toImpl) == null ? void 0 : _b.call(_a, this);
  }
  toJSON() {
    return {
      _type: this._type,
...
// ../playwright-core/src/client/stream.ts
...
// ../playwright-core/src/client/fileUtils.ts
...
// ../playwright-core/src/client/artifact.ts
...
// ../playwright-core/src/client/cdpSession.ts
...
// ../playwright-core/src/protocol/serializers.ts
...
function isError(obj) {
  ...
  return obj instanceof Error || (proto == null ? void 0 : proto.name) === "Error" || proto && isError(proto);
}
...
// ../playwright-core/src/utils/isomorphic/stringUtils.ts
...
// ../playwright-core/src/client/errors.ts
...
// ../playwright-core/src/client/events.ts
var Events = {
  AndroidDevice: {
    WebView: "webview",
    Close: "close"
...
// ../playwright-core/src/client/browser.ts
...
// ../playwright-core/src/client/clientHelper.ts
...
// ../playwright-core/src/client/clock.ts
var Clock = class {
...
// ../playwright-core/src/client/jsHandle.ts
...
// ../playwright-core/src/client/accessibility.ts
...
// ../playwright-core/src/client/coverage.ts
var Coverage = class {
  constructor(channel) {
    this._channel = channel;
  }
...
// ../playwright-core/src/client/download.ts
var Download = class {
...
// ../playwright-core/src/utils/isomorphic/cssTokenizer.ts
...
// ../playwright-core/src/utils/isomorphic/cssParser.ts
...
// ../playwright-core/src/utils/isomorphic/selectorParser.ts
...
// ../playwright-core/src/utils/isomorphic/locatorGenerators.ts
...
// ../playwright-core/src/utils/isomorphic/locatorUtils.ts
...
// ../playwright-core/src/utils/isomorphic/time.ts
...
// ../playwright-core/src/client/locator.ts
var Locator = class _Locator {
  ...
  async boundingBox(options) {
    return await this._withElement((h) => h.boundingBox(), options == null ? void 0 : options.timeout);
  }
  async check(options = {}) {
  ...
  async evaluate(pageFunction, arg, options) {
    return await this._withElement((h) => h.evaluate(pageFunction, arg), options == null ? void 0 : options.timeout);
  }
  async evaluateAll(pageFunction, arg) {
    return await this._frame.$$eval(this._selector, pageFunction, arg);
  }
  async evaluateHandle(pageFunction, arg, options) {
    return await this._withElement((h) => h.evaluateHandle(pageFunction, arg), options == null ? void 0 : options.timeout);
  }
  ...
  async ariaSnapshot(options) {
    const result = await this._frame._channel.ariaSnapshot({ ...options, mode: options == null ? void 0 : options._mode, selector: this._selector });
...
// ../playwright-core/src/client/tracing.ts
...
// ../playwright-core/src/utils/isomorphic/assert.ts
function assert(value, message) {
  if (!value)
    throw new Error(message || "Assertion error");
}

// ../playwright-core/src/utils/isomorphic/headers.ts
...
// ../playwright-core/src/client/fetch.ts
var APIRequest = class {
  ...
  async newContext(options = {}) {
    ...
    context._tracing._tracesDir = (_b = this._playwright._defaultLaunchOptions) == null ? void 0 : _b.tracesDir;
...
// ../playwright-core/src/client/waiter.ts
...
// ../playwright-core/src/utils/isomorphic/manualPromise.ts
...
// ../playwright-core/src/client/worker.ts
...
// ../playwright-core/src/utils/isomorphic/multimap.ts
var MultiMap = class {
  constructor() {
...
// ../playwright-core/src/utils/isomorphic/mimeType.ts
...
// ../playwright-core/src/client/network.ts
...
// ../playwright-core/src/client/writableStream.ts
...
// ../playwright-core/src/client/elementHandle.ts
...
// ../playwright-core/src/client/fileChooser.ts
...
// ../playwright-core/src/client/harRouter.ts
...
// ../playwright-core/src/client/input.ts
var Keyboard = class {
  constructor(page) {
    this._page = page;
  }
...
// ../playwright-core/src/client/video.ts
var Video = class {
...
// ../playwright-core/src/client/timeoutSettings.ts
...
var Page = class _Page extends ChannelOwner {
  ...
  async pdf(options = {}) {
    ...
    if (options.path) {
      ...
      await platform2.fs().promises.mkdir(platform2.path().dirname(options.path), { recursive: true });
...
// ../playwright-core/src/client/consoleMessage.ts
...
// ../playwright-core/src/client/dialog.ts
...
// ../playwright-core/src/client/webError.ts
var WebError = class {
...
// ../playwright-core/src/client/browserContext.ts
var BrowserContext = class _BrowserContext extends ChannelOwner {
  constructor(parent, type, guid, initializer) {
    ...
    (_a = this._browser) == null ? void 0 : _a._contexts.add(this);
    this._isChromium = ((_b = this._browser) == null ? void 0 : _b._name) === "chromium";
  ...
  async _onRoute(route) {
    ...
    const routeHandlers = this._routes.slice();
    for (const routeHandler of routeHandlers) {
      if ((page == null ? void 0 : page._closeWasCalled) || this._closeWasCalled)
        return;
      if (!routeHandler.matches(route.request().url()))
        continue;
      const index = this._routes.indexOf(routeHandler);
  ...
  async clearCookies(options = {}) {
    await this._channel.clearCookies({
      ...
      nameRegexSource: isRegExp2(options.name) ? options.name.source : void 0,
      nameRegexFlags: isRegExp2(options.name) ? options.name.flags : void 0,
      domain: isString(options.domain) ? options.domain : void 0,
      domainRegexSource: isRegExp2(options.domain) ? options.domain.source : void 0,
      domainRegexFlags: isRegExp2(options.domain) ? options.domain.flags : void 0,
      path: isString(options.path) ? options.path : void 0,
      pathRegexSource: isRegExp2(options.path) ? options.path.source : void 0,
      pathRegexFlags: isRegExp2(options.path) ? options.path.flags : void 0
    });
  }
  ...
  _onClose() {
    ...
    (_b = (_a = this._browserType) == null ? void 0 : _a._contexts) == null ? void 0 : _b.delete(this);
    this._disposeHarRouters();
  ...
  async close(options = {}) {
    ...
    await this._wrapApiCall(async () => {
      var _a;
      await ((_a = this._browserType) == null ? void 0 : _a._willCloseContext(this));
...
function prepareRecordHarOptions(options) {
  ...
  return {
    ...
    urlRegexSource: isRegExp2(options.urlFilter) ? options.urlFilter.source : void 0,
    urlRegexFlags: isRegExp2(options.urlFilter) ? options.urlFilter.flags : void 0,
    mode: options.mode
  };
}
...
async function toClientCertificatesProtocol(platform2, certs) {
  ...
  const bufferizeContent = async (value, path) => {
    if (value)
      return value;
    if (path)
      return await platform2.fs().promises.readFile(path);
  };
...
// ../playwright-core/src/utils/isomorphic/timeoutRunner.ts
...
// ../playwright-core/src/client/webSocket.ts
...
// ../playwright-core/src/client/android.ts
...
// ../playwright-core/src/client/browserType.ts
...
// ../playwright-core/src/client/clientInstrumentation.ts
...
// ../playwright-core/src/client/electron.ts
...
// ../playwright-core/src/client/jsonPipe.ts
...
// ../playwright-core/src/client/localUtils.ts
...
// ../playwright-core/src/utils/isomorphic/colors.ts
var webColors = {
  enabled: true,
...
// ../playwright-core/src/client/platform.ts
var noopZone = {
  push: () => noopZone,
  pop: () => noopZone,
  run: (func) => func(),
...
// ../playwright-core/src/client/selectors.ts
...
// ../playwright-core/src/client/playwright.ts
...
// ../playwright-core/src/client/connection.ts
...
var Connection = class extends EventEmitter {
  ...
  async sendMessageToServer(object, method, params, apiName, frames, stepId) {
    ...
    if (this._tracingCount && frames && type !== "LocalUtils")
      (_a = this._localUtils) == null ? void 0 : _a.addStackToTracingNoReply({ callData: { stack: frames, id } }).catch(() => {
      });
...
function formatCallLog(platform2, log) {
  if (!log || !log.some((l) => !!l))
    return "";
  return `
Call log:
${platform2.colors.dim(log.join("\n"))}
`;
}
