...
exports.kBuiltinsScript = exports.Worker = exports.PageBinding = exports.Page = exports.InitScript = void 0;
...
var _pageBinding = require("./pageBinding");
...
class PageBinding {
  constructor(name, playwrightFunction, needsHandle) {
    ...
    this.initScript = new InitScript((0, _pageBinding.createPageBindingScript)(PageBinding.kPlaywrightBinding, name, needsHandle), true /* internal */);
  ...
  static async dispatch(page, payload, context) {
    ...
    try {
      ...
      if (binding.needsHandle) {
        const handle = await context.evaluateHandle(_pageBinding.takeBindingHandle, {
          name,
          seq
        }).catch(e => null);
      ...
      context.evaluate(_pageBinding.deliverBindingResult, {
        name,
        seq,
        result
...
const kBuiltinsScript = exports.kBuiltinsScript = new InitScript(`(${_builtins.ensureBuiltins})(globalThis)`, true /* internal */);
