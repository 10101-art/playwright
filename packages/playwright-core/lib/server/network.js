...
class Route extends _instrumentation.SdkObject {
  ...
  async continue(overrides) {
    ...
    if (overrides.headers) overrides.headers = (_overrides$headers = overrides.headers) === null || _overrides$headers === void 0 ? void 0 : _overrides$headers.filter(header => header.name.toLowerCase() !== 'cookie');
