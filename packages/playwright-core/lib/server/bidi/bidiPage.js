...
exports.kPlaywrightBindingChannel = void 0;
...
const kPlaywrightBindingChannel = exports.kPlaywrightBindingChannel = 'playwrightChannel';
class BidiPage {
  ...
  async _initialize() {
    ...
    await Promise.all([this.updateHttpCredentials(), this.updateRequestInterception(), this._installMainBinding(), this._addAllInitScripts()]);
  }
  ...
  async _installMainBinding() {
    ...
    if (this._browserContext._browserContextId) return;
